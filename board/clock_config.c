...
- {id: MQS_MCLK.outFreq, value: 60/11 MHz}
- {id: PERCLK_CLK_ROOT.outFreq, value: 62.5 MHz}
- {id: SAI1_CLK_ROOT.outFreq, value: 24 MHz}
- {id: SAI1_MCLK1.outFreq, value: 24 MHz}
- {id: SAI1_MCLK2.outFreq, value: 24 MHz}
- {id: SAI1_MCLK3.outFreq, value: 30 MHz}
- {id: SAI3_CLK_ROOT.outFreq, value: 60/11 MHz}
- {id: SAI3_MCLK1.outFreq, value: 60/11 MHz}
...
- {id: CCM.SAI1_CLK_PODF.scale, value: '1', locked: true}
- {id: CCM.SAI1_CLK_PRED.scale, value: '1'}
- {id: CCM.SAI3_CLK_PODF.scale, value: '33'}
...
- {id: CCM_ANALOG.PLL3_PFD2_DIV.scale, value: '12'}
...
void BOARD_BootClockRUN(void)
{
    ...
    /* Set SAI3_CLK_PODF. */
    CLOCK_SetDiv(kCLOCK_Sai3Div, 32);
